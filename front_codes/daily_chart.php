...
<?php
    echo '<h2 class="clock" style="color : black">'.date("Y.m.d", strtotime('-1 day',time()));
    $yesterday=date("D", strtotime('-1 day',time()));
    echo' <span style = "color : blueviolet ;">'.$yesterday;
